        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quotes_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Quotes_Customers_CustomerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchase_Requests_Employees_EmployeeId",
                        column: x => x.EmployeeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quote_Details", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Quote_Details_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK_Quote_Details_Quotes_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sale_Order", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK_Sale_Order_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId");
                    table.ForeignKey(
                        name: "FK_Sale_Order_Quotes_QuoteId",
                        column: x => x.QuoteId,
                        principalTable: "Quotes",
                        principalColumn: "QuoteId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    orderDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RequestId = table.Column<int>(type: "int", nullable: true),
                    POTotal = table.Column<double>(type: "float", nullable: false),
                    SupllierId = table.Column<int>(type: "int", nullable: true),
                    POProgress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchase_Orders_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Purchase_Orders_Suppliers_SupllierId",
                        column: x => x.SupllierId,
                        principalTable: "Suppliers",
                        principalColumn: "SupplierId");
                });

            migrationBuilder.CreateTable(
                name: "PurchaseRequest_Details",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseRequest_Details", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK_Order_Details_Sale_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrder_Details", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchase_Orders_SupllierId",
                table: "Purchase_Orders",
                column: "SupllierId");

            migrationBuilder.CreateIndex(
                name: "IX_Purchase_Requests_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrder_Details_ProductId",
                table: "PurchaseOrder_Details",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequest_Details_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quote_Details_ProductId",
                table: "Quote_Details",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Quote_Details_RequestId",
                table: "Quote_Details",
                column: "RequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotes_CustomerId1",
                table: "Quotes",
                column: "CustomerId1");

            migrationBuilder.CreateIndex(
                name: "IX_Sale_Order_CustomerId",
                table: "Sale_Order",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Sale_Order_QuoteId",
                table: "Sale_Order",
                column: "QuoteId");
        }
